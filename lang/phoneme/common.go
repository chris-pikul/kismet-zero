...
// CommonPool provides a predefined collection of common phonemes that serves
// as a starting point for language generation. This pool includes basic IPA
// phonemes with appropriate rarity weights.
var CommonPool = PhonemePool{
